...
export const Home = () => {
  ...
  return (
    ...
    <section className="flex flex-col items-center">
      ...
      <a href="https://prebuiltui.com" className="flex items-center gap-2 bg-indigo-100 rounded-full p-1 pr-3 text-sm mt-23">
      ...
      <h1 className="text-center text-slate-800 text-4xl md:text-5xl/16 font-semibold max-w-3xl leading-tight bg-clip-text my-2.5 px-4">
        Reliable <span className='bg-linear-to-r from-indigo-600 to-pink-400 bg-clip-text text-transparent'>automation</span> to boost your team’s efficiency
      </h1>
      ...
      <div className="relative mt-12 w-full max-w-4xl px-4">
        ...
        <img className="relative z-1 w-full object-cover object-top" src="https://assets.prebuiltui.com/images/components/hero-section/hero-dashImage2.png" alt="" />
      </div>
