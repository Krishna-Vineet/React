...
export const Navbar = () => {
  ...
  return (
    ...
    <div ref={ref} className="">
            <nav className={`fixed top-0 left-0 bg-indigo-500 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 py-4`}>

                {/* Logo */}
                <a href="https://prebuiltui.com" className="flex items-center gap-2">
                    <svg width="157" height="40" viewBox="0 0 157 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={`h-9`}>
