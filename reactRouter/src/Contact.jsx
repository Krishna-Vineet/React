...
export const Contact = () => {
  return (
    ...
    <div className="max-w-5xl w-full mx-auto p-10 pt-30 text-gray-800 pt">
            ...
            <p className="text-left mt-4">
                ...
                <a href="mailto:contact@prebuiltui.com" className="text-indigo-600 hover:underline">contact@prebuiltui.com</a>
            </p>
